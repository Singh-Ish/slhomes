...
function get_button_popup_PPS($popup_id = 0){
	...
	switch( $button_type ){
		case 'button':
			$button_popup = '<a href="#" class="pps-btn pps-button-popup-'.$popup_id.' '.$class_style.' '.$class_run.'"  title="'.$pps_data['pps_button_title'][0].'"><i class="fa fa-pencil" class="cc"></i><span class="kk">'.$pps_data['pps_button_text'][0].'</span></a>';
			break;
