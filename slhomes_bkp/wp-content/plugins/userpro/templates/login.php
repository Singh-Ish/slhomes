...
<div class="userpro userpro-<?php echo $i; ?> userpro-<?php echo $layout; ?>" <?php userpro_args_to_data( $args ); ?>>
	...
	<div class="userpro-head" style="display:none;">
	...
	<div class="userpro-body">
		...
		<form action="" method="post" data-action="<?php echo $template; ?>">
			...
			<?php } ?>
			<div class="userpro-left" style="padding:1em 0;"><a href="#" data-template="<?php echo $args["{$template}_side_action"]; ?>"><?php echo $args["{$template}_side"]; ?></a>
